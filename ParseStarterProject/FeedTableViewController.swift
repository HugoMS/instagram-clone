...
class FeedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        query?.findObjectsInBackground(block: { (objects, error) in
            ...
            let getFollowUserQuery = PFQuery(className: "Followers")
            
            getFollowUserQuery.whereKey("follower", equalTo: (PFUser.current()?.objectId!)!)
            
            getFollowUserQuery.findObjectsInBackground(block: { (objects, error) in
                                ...
                                if let posts =  objects{
                                    ...
                                    for object in posts {
                                        ...
                                        if let post = object as? PFObject{
                                            ...
                                            self.imageFile.append(post["imageData"] as! PFFile)
        ...
        imageFile[indexPath.row].getDataInBackground { (data, error) in
            ...
            if let  imageData =  data{
                if let donwloadedImage = UIImage(data: imageData)
                {
                    ...
                    cell.postedImage.image = donwloadedImage
                }
            }
        }
